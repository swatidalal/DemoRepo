...
namespace SerializationDesearlizationHandsOn
{
    ...
    public class JsonSerialDeserial
    {
        ...
        public string SerializeInJsonFromat()
        {
           ...
           string result = JsonConvert.SerializeObject(list);
            ...
            //    File.AppendText(@"C:\Users\LENOVO\Desktop\Training\SerialDeserial\MyDataInJsonFormat.txt",))
            //{
        ...
        public void DeSerializeFromJsonFromatToListEBill(string result )
        {
            //creating an empty list 
            List<EBill> list = new List<EBill>();
            //list=(List<EBill>)JsonSerializer.Deserialize<List <EBill>>((JsonReader)result);
            list = JsonConvert.DeserializeObject<List<EBill>>(result);
